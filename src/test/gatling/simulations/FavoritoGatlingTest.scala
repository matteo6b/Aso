...
/**
 * Performance test for the Favorito entity.
 */
class FavoritoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Favorito entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created favorito")
                .get("${new_favorito_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created favorito")
            .delete("${new_favorito_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
